# -*- coding: utf-8 -*-
"""
Created on Thu Feb 25 11:55:00 2021
...
class READ_DATA:
    ...
    def read_and_stats_custom(self, a,b,num):
...
def select_options(num, dt, mr_choice, h_choice, s):
...
def psd_plots(freq, full, rms, a, b):
...
def psd_post(freq, full, rms):
    ...
    if(iacc == 1):
        ...
        output_file = parent_path / 'psd_data.csv'
        mH = len(freq)
