...
def sample_rate_check(a, b, num, sr, dt):
    ...
    if((srmax-srmin) > 0.01*sr):
        ...
        #         s = stdin.readline() # NOT TO ASK FOR INPUT
        #         s = sr
        #         sr = float(s)
        #         dt = 1/sr
        #     except ValueError:
...
def GetInteger2():
    ...
    while nnn != 1 and nnn != 2:
        try:
            ...
            print('Invalid Number. Enter integer. GetInteger2')
    return nnn
...
def GetInteger3():
    ...
    while nnn != 1 and nnn != 2 and nnn != 3:
        try:
            ...
            print('Invalid Number. Enter integer. GetInteger3')
    return nnn
...
def WriteData2(nn, aa, bb, output_file):
    """
